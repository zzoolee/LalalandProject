...
@WebServlet(value = "/adminattraction.do")
public class AdminAttrController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("views/enjoy/adminattraction.jsp");
		rd.forward(req, resp);
