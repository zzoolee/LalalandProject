...
@WebServlet(value = "/qna/userdetail.do")	
public class custQnaDetailController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//String qSort = req.getParameter("qSort");
		 ...
		 System.out.println("사용자 디테일 관리자 아이디 세션 :" + adminId);
		...
		//4. 큐엔에이 디테일로 전달
		req.getRequestDispatcher("/views/qna/custQnaDetail.jsp").forward(req, resp);
