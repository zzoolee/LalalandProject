...
@WebServlet(value = "/adminoffgdshop.do")
public class AdminOffGdController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("views/goods/adminoffgdshop.jsp");
		rd.forward(req, resp);
