...
<!-- board seach area -->
	<form action="<%=request.getContextPath()%>/qna/userupdate.do"method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="qCd" value="<%=cqv.getqCd()%>">
			...
			<div id="board-search">
				<div class="container">
					<div class="search-window">
						<h5>
						문의글 번호:&nbsp;<%=cqv.getqCd()%></h5>
						문의 유형:&nbsp; 
						<select name="qSort">
							<option value="시설/동물원">시설/동물원 이용안내</option>
							<option value="이용정보">홈페이지 이용정보</option>
				...
				<div class="container">
					<table class="board-table">
						<thead>
							<tr>
								<td>제목:&nbsp;&nbsp;</td>
								<td><textarea cols="140" name="qTitle"><%=cqv.getqTitle()%></textarea></td>
							</tr>
							<tr>
								<td>내용:&nbsp;&nbsp;</td>
								<td><textarea rows="20" cols="140" name="qContent"><%=cqv.getqContent()%></textarea></td>
							</tr>
						</thead>
						<%
		...
		<p>
			<button type="submit" class="btn btn-dark">글 수정</button></p>
		</form>
	</section>
